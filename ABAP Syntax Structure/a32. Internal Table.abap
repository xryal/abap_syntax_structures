...
"duplicate value eklemez. ama iki appendi toplar
wa_st2-field1 = 1000.
wa_st2-field2 = 'merhaba kullanıcı'.
wa_st2-field3 = 'naber'.
COLLECT wa_st2 into it_st1 .
...
INSERT wa_st2 INTO TABLE it_st1. "internal tablonun en son satırını hedefler.
INSERT wa_st2 INTO  it_st1 INDEX 2.

."---------------------------------------------------------------------------------------------

READ TABLE it_st1  INTO wa_st2  INDEX 2.
IF sy-subrc = 0.
  WRITE :/ 'okuma işlemi başarılı'.
ENDIF.
