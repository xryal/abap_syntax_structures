SELECTION-SCREEN BEGIN OF SCREEN 1001 AS SUBSCREEN .
  ...
  SELECTION-SCREEN BEGIN OF BLOCK b4 WITH FRAME TITLE frame4.
    ...
    SELECTION-SCREEN BEGIN OF LINE.
      ...
      SELECTION-SCREEN COMMENT 01(15) TEXT-003 MODIF ID a1.
    ...
    SELECTION-SCREEN BEGIN OF LINE.
      ...
      SELECTION-SCREEN COMMENT 01(14) TEXT-004 MODIF ID b1.
      SELECTION-SCREEN POSITION 17.
      SELECT-OPTIONS so_d2 FOR zab_faturat_item-ab_fatura_id MODIF ID b1.
      SELECT-OPTIONS so_d3 FOR zab_faturat_item-ab_faturalanan_urun MODIF ID b1.
